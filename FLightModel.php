...
{
    use FMultiLingualModelTrait;
    use FSimpleModelCacheTrait;
    ...
    /**
     * Short cut to @normalizeLanguageFields()
     * @return type
     */
    public function langs()
    {
        return $this->afterFind('normalizeLanguageFields');
    }
    
    /**
	 * Sets the parameters about query caching.
     * 
     * Warning: do not use this method mixed with mathods of FSimpleModelCacheTrait.
     * 
    ...
    /**
     * Short cut to @FMultiLingualModelTrait::getMSelect().
     * @param type $columns
     * @param type $languageFields
     * @param type $withAllLanguages
     * @return \FLightModel
     */
    public function mselect($columns, $languageFields = [], $withAllLanguages = false)
    {
        $this->select(self::getMSelect($columns, $languageFields, $withAllLanguages));
    ...
    {
        $this->andWhere('active=:val', [':val' => $value]);
